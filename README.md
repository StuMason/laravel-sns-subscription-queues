[![Build Status](https://travis-ci.org/kirschbaum/laravel-sns-subscription-queues.svg?branch=master)](https://travis-ci.org/kirschbaum/laravel-sns-subscription-queues)
